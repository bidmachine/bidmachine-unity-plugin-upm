...
{
    public class InterstitialRequestBuilderIosUnityBridge : IIosAdRequestBuilderBridge
    {
        [DllImport("__Internal")]
        private static extern void BidMachineSetInterstitialRequestDelegate(AdRequestSuccessCallback onSuccess, AdRequestFailedCallback onFailed, AdRequestExpiredCallback onExpired);
        ...
        public void SetAdContentType(string contentType)
        {
         ...
         {
            BidMachineSetInterstitialRequestDelegate(onSuccess, onFailed, onExpired);
         }
    }
}
