...
{
    public delegate void AdRequestSuccessCallback(IntPtr ad, IntPtr auctionResultUnmanagedPointer);
    public delegate void AdRequestFailedCallback(IntPtr error);
    public delegate void AdRequestExpiredCallback(IntPtr ad);

    public class RewardedRequestBuilderIosUnityBridge : IIosAdRequestBuilderBridge
    {
        [DllImport("__Internal")]
        private static extern void BidMachineSetRewardedRequestDelegate(AdRequestSuccessCallback onSuccess, AdRequestFailedCallback onFailed, AdRequestExpiredCallback onExpired);
        ...
        public void SetAdContentType(string contentType)
        {
         ...
         {
            BidMachineSetRewardedRequestDelegate(onSuccess, onFailed, onExpired);
         }
    }
}
#endif
