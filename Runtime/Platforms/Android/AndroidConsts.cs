...
namespace BidMachineInc.Ads.Android
{
    internal static class AndroidConsts
    {
        ...
        public const string BannerRequestBuilderClassName = "io.bidmachine.banner.BannerRequest$Builder";
        public const string BannerRequestListenerClassName = "io.bidmachine.banner.BannerRequest$AdRequestListener";

        // Interstitial Ad constants
        public const string InterstitialAdClassName = "io.bidmachine.interstitial.InterstitialAd";
        public const string InterstitialListenerClassName = "io.bidmachine.interstitial.InterstitialListener";
        public const string InterstitialRequestBuilderClassName = "io.bidmachine.interstitial.InterstitialRequest$Builder";
        public const string InterstitialRequestListenerClassName = "io.bidmachine.interstitial.InterstitialRequest$AdRequestListener";
        ...
        public const string RewardedRequestBuilderClassName = "io.bidmachine.rewarded.RewardedRequest$Builder";
